...
namespace MindTouch.Dream.Test {
    ...
    public class ContainerTests {
        ...
        public void Can_set_request_scope_registration_on_provided_container() {
            ...
            var hostInfo = DreamTestHelper.CreateRandomPortHost(new XDoc("config"), builder.Build(ContainerBuildOptions.None));
    ...
    [DreamService("ContainerTestService", "Copyright (c) 2010-2014 MindTouch, Inc.", SID = new string[] { "sid://mindtouch.com/ContainerTestService" })]
