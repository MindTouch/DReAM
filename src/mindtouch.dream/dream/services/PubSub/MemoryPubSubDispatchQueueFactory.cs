...
namespace MindTouch.Dream.Services.PubSub {
    public class MemoryPubSubDispatchQueueFactory : IPersistentPubSubDispatchQueueFactory {
        private readonly TaskTimerFactory _taskTimerFactory;
        private readonly TimeSpan _retryTime;

        public MemoryPubSubDispatchQueueFactory(TaskTimerFactory taskTimerFactory, TimeSpan retryTime) {
