    ...
    public class HttpHandler : IHttpHandler, IPlugEndpoint {
        ...
        void IHttpHandler.ProcessRequest(HttpContext httpContext) {
            ...
            try {
                ...
                DreamMessage message = new DreamMessage(DreamStatus.Ok, new DreamHeaders(httpContext.Request.Headers), MimeType.New(httpContext.Request.ContentType), httpContext.Request.ContentLength, httpContext.Request.InputStream);
